...
<?php $component = App\View\Components\NotFound::resolve(['description' => __('Sorry, no results were found.', 'gds'),'searchLabel' => __('Wanna try again?', 'gds')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/web/app/themes/gds/resources/views/search.blade.php ENDPATH**/ ?>